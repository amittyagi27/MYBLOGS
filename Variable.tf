...
variable "compartment_prod_ocid" {
  type        = string
  description = "provide value of compartment id for Production"
}
...
variable "compartment_preprod_ocid" {
  type        = string
...
variable "vcn_prod_cidr" {
  type        = string
  description = "provide value of vcn prod cidr if you want a separate VCN for Prod"
}

variable "vcn_prod_dns_prefix" {
  type        = string
  description = "provide value of vcn prod dns if you want a separate VCN for Prod"
}
...
variable "subnet_dev_pvt_cidr" {
  type        = string
  description = "provide value of private subnet cidr"
}

variable "subnet_prod_pub_cidr" {
  type        = string
  description = "provide value of public subnet cidr"
}

variable "subnet_prod_pvt_cidr" {
  type        = string
  description = "provide value of private subnet cidr"
}
...
variable "rdg_custom_image" {
  type        = string
  description = "provide value of RDG Custome Image"
}

variable "rdg_compute_shape" {
  type        = string
  description = "provide value of RDG Compute Shape"
}

variable "rdg_compute_shape_prod" {
  type        = string
  description = "provide value of RDG Compute Shape for Production"
}

variable "rdg_ssh_pub_key" {
  type        = string
  description = "provide value of RDG Pub SSH Key"
}
